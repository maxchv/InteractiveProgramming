...
Изучаются базовые концепции событий-ориентированного программирвоания, основные отличия между локальными и глобальными переменными, создание простых интерактивных программ
...
При вызове этой функии мы увидим в консоли сообщение: `dog.png`.
...
* `preload()` - загружаем внешние файлы (или `assets`) в нашу игру. 
* `create()` - здесь мы определяем игровые объекты `GameObjects`, которые нобходимы для старта нашей игры. 
* `update()` - здесь мы реализуем анимацию и взаимодействие в нашей игре
